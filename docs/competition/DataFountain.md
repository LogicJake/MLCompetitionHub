...
## 数据集隐私求交技术 <sup style="color:red">[new]<sup>  
...
## 面向低资源和增量类型的命名实体识别 <sup style="color:red">[new]<sup>  
...
## 领域多事件信息联合抽取 <sup style="color:red">[new]<sup>  
...
## 基于亚米级影像的精细化目标检测 <sup style="color:red">[new]<sup>  
...
## 基于传感器信号的航迹实时关联与轨迹融合任务 <sup style="color:red">[new]<sup>  
...
## 基于高分辨率遥感可见光数据的细粒度密集船只目标检测任务 <sup style="color:red">[new]<sup>  
...
## 多粒度时序知识图谱问答 <sup style="color:red">[new]<sup>  
...
## Data-To-Text 硬约束下的受控文本生成 <sup style="color:red">[new]<sup>  
