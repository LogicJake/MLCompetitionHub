...
## ChatGLM 实践大赛 ——论文学科分类（Easy） <sup style="color:red">[new]<sup>  
...
## ChatGLM 实践大赛 ——问答式科研知识库（Medium） <sup style="color:red">[new]<sup>  
...
## ChatGLM 实践大赛 ——论文综述和对比分析（Medium） <sup style="color:red">[new]<sup>  
...
## ChatGLM 实践大赛 ——投稿期刊会议推荐（Medium） <sup style="color:red">[new]<sup>  
...
## ChatGLM 实践大赛 ——审稿回复（Medium） <sup style="color:red">[new]<sup>  
...
## ChatGLM 实践大赛 ——论文检索（Hard） <sup style="color:red">[new]<sup>  
...
## ChatGLM 实践大赛 ——论文推荐和科技情报生成（Hard） <sup style="color:red">[new]<sup>  
