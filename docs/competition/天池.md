...
## MICCAI 2023 Challenges ：STS-基于3D CBCT的牙齿分割任务(赛季 1) <sup style="color:red">[new]<sup>  
...
## MICCAI 2023 Challenges ：STS-基于2D 全景图像的牙齿分割任务(赛季 1) <sup style="color:red">[new]<sup>  
